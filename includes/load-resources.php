...
function load_resources() {
    ...
    wp_enqueue_style( 'dialog',         plugins_url( 'public/css/dialog.css', SPOT_LOCATOR__PLUGIN_URL));
    ...
    wp_enqueue_script( 'jquery-3.3.1', plugins_url( 'public/js/jquery-3.3.1.min.js', SPOT_LOCATOR__PLUGIN_URL), array(),null, true);
    wp_enqueue_script( 'jquery-ui-1.12.1.min', plugins_url( 'public/js/jquery-ui-1.12.1.min.js', SPOT_LOCATOR__PLUGIN_URL), array(),null, true);
...
function spotslocator_enqueue_admin_scripts(){
    ...
    wp_register_style('admin_style', plugins_url( 'public/css/admin_style.css', SPOT_LOCATOR__PLUGIN_URL));
