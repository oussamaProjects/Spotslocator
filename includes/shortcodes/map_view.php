...
function map_view($atts)
{
  ...
  <article id="mapfindspots" class=" fr">
    <div class="container ">
      <p class="frenchmap desc">Entrez une ville, un département ou un code postal dans le champ ci-dessous, ou
        sélectionnez un département directement sur la carte</p>
      <p id="map_error_msg"></p>

      <input name="google_loc" placeholder="Indiquez un lieu" type="text" class=" form-control" id="google_loc" data-required="1" />
      ...
      <div id="dialog_training_center_detail" title="" class="mydialog">
        <div class="box-close">
          <div class="under-box-close">
            <a class="close" data-dismiss="modal" onclick="$('#dialog_training_center_detail').dialog('close');">
